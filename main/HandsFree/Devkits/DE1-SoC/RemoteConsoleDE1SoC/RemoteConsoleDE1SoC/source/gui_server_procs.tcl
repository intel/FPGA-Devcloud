...
##### Get initial credentials from previous session
	...
	set password ""
	set sof_file ""
	set cdf_file "Optional - Use for SoC Kits"
	set mode "initialize"
	...
	return [list $ips $credential_fh $ip_address $password $sof_file $mode $pws $cdf_file]
...
proc link_press { ips credential_fh ip_address password sof_file pws cdf_file} {
	...
	puts "${sof_file}"
	set  cdf_file [file normalize $cdf_file]
	puts "${cdf_file}"
	return "connecting"

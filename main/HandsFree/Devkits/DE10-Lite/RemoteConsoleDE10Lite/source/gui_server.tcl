...
lassign [initial_credentials] ips credential_fh ip_address password sof_file mode pws
...
grid [ ttk::combobox .ip_address -textvariable ip_address -values $ips -background white \
	-font {Courier -17 } -foreground black -justify left -state normal -width 15] -padx 10 -pady 6 -column 2 -row 1 -columnspan 2 -sticky "snew"
...
grid [entry .pw_ent -background white -foreground black  -relief ridge -width 17 \
	-font {Courier -17} -textvariable password -justify left -state normal -state normal ] -padx 10 -pady 6 -column 2 -row 2 -columnspan 2 -sticky "snew"

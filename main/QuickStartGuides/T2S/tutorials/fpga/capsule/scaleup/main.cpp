...
int main(void)
{
    ...
    Var P;
    Func Pose("Pose", Float(32), { P }, Place::Device);
    Func Weight("Weight", Float(32), { P }, Place::Device);
    Func Vote("Vote", Float(32), { P }, Place::Device);
    Func Out("Out", Place::Device);
    ...
    Func pLoader("pLoader", Place::Device), pFeeder("pFeeder", Place::Device), wLoader("wLoader", Place::Device), wFeeder("wFeeder", Place::Device);

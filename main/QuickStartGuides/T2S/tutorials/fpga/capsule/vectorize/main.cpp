...
#define P_order     r_cii,         coimw,   bi,   w,  h,  r_cio,         r_mk,        r_kw,        r_kh,   mh,  coo,  bo
#define P           r_cii,         coimw,   bi,   w,  h,  r_cio,         r_mk,        r_kw,        r_kh,   mh,  coo,  bo
#define P_coimw     r_cii,         coimw-1, bi,   w,  h,  r_cio,         r_mk,        r_kw,        r_kh,   mh,  coo,  bo
#define P_bi        r_cii,         coimw,   bi-1, w,  h,  r_cio,         r_mk,        r_kw,        r_kh,   mh,  coo,  bo
#define P_cii       r_cii-1,       coimw,   bi,   w,  h,  r_cio,         r_mk,        r_kw,        r_kh,   mh,  coo,  bo
#define P_cio       r_cii+R_CII-1, coimw,   bi,   w,  h,  r_cio-1,       r_mk,        r_kw,        r_kh,   mh,  coo,  bo
#define P_mk        r_cii+R_CII-1, coimw,   bi,   w,  h,  r_cio+R_CIO-1, r_mk-1,      r_kw,        r_kh,   mh,  coo,  bo
#define P_kw        r_cii+R_CII-1, coimw,   bi,   w,  h,  r_cio+R_CIO-1, r_mk+R_MK-1, r_kw-1,      r_kh,   mh,  coo,  bo
#define P_kh        r_cii+R_CII-1, coimw,   bi,   w,  h,  r_cio+R_CIO-1, r_mk+R_MK-1, r_kw+R_KW-1, r_kh-1, mh,  coo,  bo

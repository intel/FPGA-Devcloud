...
if [ $1 = "emulator" ]; then
  ...
  g++ $THIS_TUTORIAL_PATH/../host.cpp -g -DSIZE=8 -DBB=16 -DB=32768 -DLINUX -DALTERA_CL -fPIC -I$INTELFPGAOCLSDKROOT/examples_aoc/common/inc  $INTELFPGAOCLSDKROOT/examples_aoc/common/src/AOCLUtils/opencl.cpp $INTELFPGAOCLSDKROOT/examples_aoc/common/src/AOCLUtils/options.cpp -I$INTELFPGAOCLSDKROOT/host/include $AOCL_LIBS -lelf -o host.out
  env BITSTREAM="bitstream/lu-vec.aocx" ./host.out
fi
